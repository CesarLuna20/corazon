...
// ⚠️ Alias: escudo_agua => usa el mismo atlas que muro_agua
export const SPELL_SPRITES: Record<string, SpriteAsset> = {
  ...
  chorro_agua: {
    ...
    meta: { rows: 2, cols: 2, fps: 12, frameW: 64, frameH: 64 },
  },
  proyectil_roca: {
  ...
  rayo_energia: {
    ...
    meta: { rows: 2, cols: 2, fps: 14, frameW: 64, frameH: 64 },
  },

  // Agua / escudo
  muro_agua: {
    source: require("../../assets/spells/water_wall.png"),
    meta: { rows: 2, cols: 2, fps: 8, frameW: 64, frameH: 64 },
  },
  escudo_agua: {
    source: require("../../assets/spells/water_wall.png"),
    meta: { rows: 2, cols: 2, fps: 8, frameW: 64, frameH: 64 },
  ...
  prision_hielo: {
    source: require("../../assets/spells/prision_yelo.png"),
    meta: { rows: 2, cols: 2, fps: 8, frameW: 64, frameH: 64 },
  },
  eclipse: {
